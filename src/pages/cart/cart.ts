...
export class CartPage {
  ...
  constructor(private badge: Badge,private WP: WoocommerceProvider, public loadingCtrl : LoadingController, public events: Events, private appCtrl: App, public navCtrl: NavController, public navParams: NavParams, public storage: Storage, public ngZone: NgZone, public viewCtrl: ViewController, public toastController: ToastController) {
  ...
  checkout(){
    this.storage.get("userLoginInfo").then( (data) => {
      ...
      if(data != null){
        ...
        //this.appCtrl.getRootNav().push(LoginPage, {next: CheckoutPage});
      }
    })
