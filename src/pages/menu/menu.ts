...
export class MenuPage {
  ...
  constructor(public events: Events, private WP: WoocommerceProvider, public navCtrl: NavController, public navParams: NavParams, public appCtrl: App, public storage: Storage, public modalCtrl: ModalController) {
