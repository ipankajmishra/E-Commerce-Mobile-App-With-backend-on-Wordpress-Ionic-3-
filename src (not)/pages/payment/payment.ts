...
export class PaymentPage {
  ...
  constructor(public navCtrl: NavController,public alertCtrl: AlertController,public loadingCtrl : LoadingController, public viewCtrl: ViewController, public navParams: NavParams,public storage: Storage) {
...
paypayPal(){
    ...
    if( this.razorsuccess == true)
    {
      //alert('payment_id: ' + payment_id);
      let data1: any = {};
      data1 = {
      payment_details: {
        method_id: this.paymentid,
        method_title: "RazorPay Prepaid",
        paid: true,
        //coupon_lines: this.userInfo.coupon
      },
